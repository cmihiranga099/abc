...
<section class="relative bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16 md:py-24">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-lg text-gray-100">Choose the perfect package for your special event</p>
    </div>
</section>
...
<section class="py-16 md:py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl md:text-4xl font-bold text-center mb-4">Our Pricing Plans</h2>
        <p class="text-center text-gray-600 mb-12">Select the package that best fits your needs</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-8 text-center">
                    ...
                    <p class="text-4xl font-bold mb-4">$1,500</p>
                    <p class="text-sm opacity-90">For gatherings up to 50 guests</p>
                </div>
                <div class="p-8">
                    ...
                    <a href="/contact" class="w-full px-4 py-2 bg-blue-500 text-white font-bold rounded-lg hover:bg-blue-600 transition text-center block">
                        Choose Plan
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-2xl overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2 border-4 border-purple-500 relative">
                <div class="absolute top-0 right-0 bg-purple-500 text-white px-4 py-1 text-sm font-bold">POPULAR</div>
                <div class="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-8 text-center">
                    <h3 class="text-2xl font-bold mb-2">Professional</h3>
                    <p class="text-4xl font-bold mb-4">$4,500</p>
                    <p class="text-sm opacity-90">For gatherings up to 200 guests</p>
                </div>
                <div class="p-8">
                    <ul class="space-y-4 mb-8">
                        <li class="flex items-center">
